...
import com.example.android.inventoryapp.data.BierContract;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    private void addValuesToEditItem(long itemId) {
        ...
        cursor.moveToFirst();
        nameEdit.setText(cursor.getString(cursor.getColumnIndex(BierContract.StockEntry.COLUMN_NAME)));
        priceEdit.setText(cursor.getString(cursor.getColumnIndex(BierContract.StockEntry.COLUMN_PRICE)));
        quantityEdit.setText(cursor.getString(cursor.getColumnIndex(BierContract.StockEntry.COLUMN_QUANTITY)));
        supplierNameEdit.setText(cursor.getString(cursor.getColumnIndex(BierContract.StockEntry.COLUMN_SUPPLIER_NAME)));
        supplierPhoneEdit.setText(cursor.getString(cursor.getColumnIndex(BierContract.StockEntry.COLUMN_SUPPLIER_PHONE)));
        supplierEmailEdit.setText(cursor.getString(cursor.getColumnIndex(BierContract.StockEntry.COLUMN_SUPPLIER_EMAIL)));
        imageView.setImageURI(Uri.parse(cursor.getString(cursor.getColumnIndex(BierContract.StockEntry.COLUMN_IMAGE))));
    ...
    private int deleteAllRowsFromTable() {
        ...
        return database.delete(BierContract.StockEntry.TABLE_NAME, null, null);
    }
    ...
    private int deleteOneItemFromTable(long itemId) {
        ...
        int rowsDeleted = database.delete(
                BierContract.StockEntry.TABLE_NAME, selection, selectionArgs);
        return rowsDeleted;
    }
